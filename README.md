...
- Live Site URL: [Play Tic Tac Toe on Replit!](https://replit.com/@faraja/TicTacToe-Using-a-Dictionary#main.py) - Click the green "Run" button and play in the console.
